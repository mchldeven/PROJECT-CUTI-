				...
				<div class="pd-20 card-box mb-30">
					...
					<form method="post" action="">
						...
						<div class="row">
							...
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
									<label style="font-size:16px;"><b>Jenis Kelamin</b></label>
							...
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
									<label style="font-size:16px;"><b>No Telpon</b></label>
							...
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
									<label style="font-size:16px;"><b>Jumlah Hari yang diajukan</b></label>
							...
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
									<label style="font-size:16px;"><b>Sisa Hak Cuti Karyawan</b></label>
						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
								   <label style="font-size:16px;"><b>Tanggal Pengajuan Cuti</b></label>
								   <?php
							...
							<div class="col-md-4">
								<div class="form-group">
									<label style="font-size:16px;"><b>STATUS HEAD</b></label>
							...
							<div class="col-md-4">
								<div class="form-group">
									<label style="font-size:16px;"><b>STATUS HC</b></label>
