	...
	<div class="main-container">
		<div class="pd-ltr-20">
			<div class="card-box pd-20 height-100-p mb-30">
				<div class="row align-items-center">
					...
					<div class="col-md-8">
						...
						<p class="font-18 max-width-600">Selamat Datang di E-CUTI UNIVERSALBPR
				</div>
			</div>
			...
			<!--	<div class="col-lg-4 col-md-6 mb-20">
					<div class="card-box height-100-p pd-20 min-height-200px">
						<div class="d-flex justify-content-between">
							...
							<div class="table-actions">
								<a title="VIEW" href="staf.php"><i class="icon-copy ion-disc" data-color="#17a2b8"></i></a>	
							</div>
						</div>
			...
			<div class="card-box mb-30">
				<div class="pd-20">
					<h2 class="text-blue h4">Hisotry Cuti</h2>
				</div>
				<div class="pb-20">
					<table class="data-table table stripe hover nowrap">
						<thead>
							<tr>
								<th class="table-plus">TIPE Cuti</th>
								<th>DARI TANGGAL</th>
