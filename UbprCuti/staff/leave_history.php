	...
	<div class="main-container">
		<div class="pd-ltr-20">
			<div class="title pb-20">
				<h2 class="h3 mb-0">History Cuti</h2>
			</div>
			<div class="row pb-10">
					...
					<div class="card-box height-100-p widget-style3">
						...
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								...
								<div class="font-14 text-secondary weight-500">total pengajuan cuti</div>
							</div>
			...
			<div class="card-box mb-30">
				<div class="pd-20">
						<h2 class="text-blue h4">Data Cuti Saya</h2>
					</div>
				<div class="pb-20">
