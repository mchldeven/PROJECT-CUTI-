...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>E-CUTI UBPR</title>

	<!-- Site favicon -->
	<link rel="apple-touch-icon" sizes="100x32" href="src/images/ubpr.png">
	<link rel="icon" type="image/png" sizes="32x32" href="src/images/ubpr.png">
	<link rel="icon" type="image/png" sizes="16x16" href="src/images/ubpr.png">
	...
	<div class="login-header box-shadow">
		<div class="container-fluid d-flex justify-content-between align-items-center">
			<div class="brand-logo">
				<a href="login.html">
					<img src="src/images/bpr123.png" alt="">
				</a>
			</div>
		</div>
	</div>
				...
				<div class="col-md-6 col-lg-5">
					<div class="login-box bg-white box-shadow border-radius-10">
						<div class="login-title">
							<h2 class="text-center text-primary">E-CUTI UNIVERSAL BPR</h2>
						</div>
							...
							<div class="row">
								<div class="col-sm-12">
									<div class="input-group mb-0">
									   ...
									   <div class="btn btn-primary btn-lg btn-block"><a href="../index.html">KEMBALI KE HCMS</a></div>
								</div>
									</div>
								</div>
							</div>
