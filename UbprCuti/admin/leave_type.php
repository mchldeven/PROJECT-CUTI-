...
<?php 
	 if (isset($_GET['delete'])) {
		...
		if ($result) {
			echo "<script>alert('Tipe Cuti Berhasil Dihapus');</script>";
 ...
 if(isset($_POST['add']))
{
     ...
     if ($count > 0){ 
     	echo "<script>alert('Tipe Cuti sudah ada');</script>";
      }
      else{
		...
		if ($query) {
			echo "<script>alert('Tipe Cuti Berhasil Ditambahkan');</script>";
			echo "<script type='text/javascript'> document.location = 'leave_type.php'; </script>";
		}
    }
					...
					<div class="row">
						<div class="col-lg-4 col-md-6 col-sm-12 mb-30">
							<div class="card-box pd-30 pt-10 height-100-p">
								<h2 class="mb-30 h4">Tambah Kategori Cuti</h2>
								<section>
									...
									<div class="col-sm-12 text-right">
										<div class="dropdown">
										   <input class="btn btn-primary" type="submit" value="Tambahkan" name="add" id="add">
									    </div>
									</div>
								   </form>
							    </section>
						...
						<div class="col-lg-8 col-md-6 col-sm-12 mb-30">
							<div class="card-box pd-30 pt-10 height-100-p">
								<h2 class="mb-30 h4">List Kategori Cuti</h2>
								<div class="pb-20">
									<table class="data-table table stripe hover nowrap">
										<thead>
										<tr>
											<th class="table-plus">Jenis Cuti</th>
											<th class="table-plus">Deksripsi</th>
