		...
		<div class="pd-ltr-20">
			<div class="card-box pd-20 height-100-p mb-30">
				<div class="row align-items-center">
					<div class="col-md-4 user-icon">
						<img src="../src/images/gambar2.png" alt="">
					</div>
					<div class="col-md-8">
						...
						<p class="font-18 max-width-600">Selamat datang di sistem E-CUTI UNIVERSALBPR.</p>
					</div>
				</div>
			</div>
			<div class="title pb-20">
				<h2 class="h3 mb-0">Informasi Data</h2>
			</div>
			<div class="row pb-10">
					...
					<div class="card-box height-100-p widget-style3">
						...
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								...
								<div class="font-14 text-secondary weight-500">Total Karyawan</div>
							</div>
					...
					<div class="card-box height-100-p widget-style3">
						...
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								...
								<div class="font-14 text-secondary weight-500">Approved Cuti</div>
							</div>
							<div class="widget-icon">
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-6 mb-20">
					<div class="card-box height-100-p pd-20 min-height-200px">
						<div class="d-flex justify-content-between">
							<div class="h5 mb-0">Karyawan</div>
							<div class="table-actions">
								<a title="VIEW" href="staff.php"><i class="icon-copy ion-disc" data-color="#17a2b8"></i></a>	
							</div>
						</div> 
			...
			<div class="card-box mb-30">
				<div class="pd-20">
						<h2 class="text-blue h4">DATA PENGAJUAN CUTI</h2>
					</div>
				<div class="pb-20">
