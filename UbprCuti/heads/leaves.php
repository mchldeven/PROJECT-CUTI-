	...
	<div class="main-container">
		<div class="pd-ltr-20">
			...
			<div class="card-box mb-30">
				<div class="pd-20">
						<h2 class="text-blue h4">PENGAJUAN CUTI</h2>
					</div>
				<div class="pb-20">
								...
								<td>
									<div class="dropdown">
										...
										<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
											<a class="dropdown-item" href="leave_details.php?leaveid=<?php echo $row['lid']; ?>"><i class="dw dw-eye"></i> Lihat</a>
											<a class="dropdown-item" href="admin_dashboard.php?leaveid=<?php echo $row['lid']; ?>"><i class="dw dw-delete-3"></i> Hapus</a>
										</div>
									</div>
								</td>
							</tr>
