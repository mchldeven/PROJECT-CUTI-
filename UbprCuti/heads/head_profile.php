												...
												<div class="weight-500 col-md-12 pd-5">
													<div class="form-group">
														<div class="custom-file">
															...
															<label class="custom-file-label" for="file" id="selector">Pilih Gambar</label>		
														</div>
													</div>
												</div>
							...
							<div class="profile-tab height-100-p">
								<div class="tab height-100-p">
									<ul class="nav nav-tabs customtab" role="tablist">
										<li class="nav-item">
											<a class="nav-link active" data-toggle="tab" href="#timeline" role="tab">Rekam Cuti</a>
										</li>
										<li class="nav-item">
												...
												<div class="profile-timeline">
													...
													<div class="profile-timeline-list">
														<ul>
															...
															<li>
																<div class="date"><?php echo $row['num_days']; ?> Hari</div>
											...
											<div class="profile-setting">
												<form method="POST" enctype="multipart/form-data">
													<div class="profile-edit-list row">
														<div class="col-md-12"><h4 class="text-blue h5 mb-20">Edit Profile</h4></div>
														...
														<div class="weight-500 col-md-6">
															...
															?>
															<div class="form-group">
																<label>Hari Cuti Tersedia</label>
