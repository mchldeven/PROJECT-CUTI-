	...
	<div class="main-container">
		<div class="pd-ltr-20">
					...
					<div class="card-box height-100-p widget-style3">
						...
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								...
								<div class="font-14 text-secondary weight-500">Karyawan</div>
							</div>
							<div class="widget-icon">
					...
					<div class="card-box height-100-p widget-style3">
						...
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								...
								<div class="font-14 text-secondary weight-500">ADMIN WEB</div>
							</div>
							<div class="widget-icon">
			...
			<div class="card-box mb-30">
				<div class="pd-20">
						<h2 class="text-blue h4">SEMUA KARYAWAN</h2>
					</div>
				<div class="pb-20">
					<table class="data-table table stripe hover nowrap">
						<thead>
							<tr>
								<th class="table-plus">NAMA PANJANG</th>
								<th>EMAIL</th>
